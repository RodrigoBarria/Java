...
import java.io.ByteArrayOutputStream;
        ...
        public class Recoleccion extends AppCompatActivity implements View.OnLongClickListener{
                ...
                EditText tbxIdr, tbxFechar, tbxLatitud, tbxLongitud, tbxComentarior;
                Spinner spnCodPlantR, spnRutCR;
                Intent intent2;
                Bitmap bmp2;
                final int cons = 0;
        ...
        private void init(){
                ...
                spnRutCR = (Spinner) findViewById(R.id.spnRutCR);
                spnCodPlantR = (Spinner) findViewById(R.id.spnCodPlantR);
                ...
                public void Grabar1 (View v)
                {
                        ...
                        obtdet5 = spnRutCR.toString();
                        obtdet6 = spnCodPlantR.toString();
